...
export function CountryCardList({
  ...
  const getFlagComponent = (countryName: string, iso3: string) => {
    // Get ISO2 code from countryInfo for proper flag rendering
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-2">
                      {getFlagComponent(country.name, country.iso)}
                      <div>
                  ...
                  {/* Top Topic Preview */}
                  {country.topTopics.length > 0 && country.topTopics[0] && (
