...
import { countriesData, type Emotion, type CountryData } from '@/lib/data';
...
export default function Home() {
  ...
  const countries = useMockData || backendCountries.length === 0 ? countriesData : backendCountries;
  ...
  return (
    <div className="flex flex-col h-screen bg-zinc-950">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-[7] relative">
          ...
          <div className="absolute top-4 left-1/2 -translate-x-1/2 z-[1000] bg-zinc-900/95 backdrop-blur-sm border border-zinc-700 rounded-lg px-3 py-1.5 shadow-xl flex items-center gap-2">
            ...
            {error && (
              ...
              >
                {useMockData ? 'Try Backend' : 'Use Mock Data'}
              </button>
            )}
        ...
        {/* Sidebar */}
        <div className="flex-[3] bg-zinc-900 border-l border-zinc-800 flex flex-col">
          {/* Search Bar */}
          <SearchBar
      ...
      {/* Analytics Panel (Full Width Below) */}
      <AnalyticsPanel />
